...
#################################################################
# 🛡️ adguard-tui - Simple start-up script                   #
#################################################################
...
# Config
upstream_repo="https://github.com/obaraelijah/adguard-tui"
adguard_version="latest"
download_location="./adguard"
...
download_link="$upstream_repo/releases/$adguard_version/download/$bin_target"
